...
NGame = {
	...
	PRINT_MESSAGES_TO_GAME_LOG = 1, -- Should we print messages to the game log or not ( 0 = false, 1 = true )
},
...
NDiplomacy = {
	...
	HRE_VOTE_TOO_SMALL = 10, --taedium
	HRE_VOTE_BIG_COUNTRY = 0, --taedium
	HRE_VOTE_VERY_BIG_COUNTRY = 0, --taedium
	...
	AE_HRE_INTERNAL = 1, -- TAEDIUM, was 0.5 - problem?
	...
	REMOVE_ELECTORATE_INFLUENCE_COST = 100,			-- The amount of IA Remove Electorate costs.
	...
	IMPERIAL_CITY_IA = 0.002,						-- Monthly per imperial free city
...
NCountry = {
	...
	SIBERIAN_FRONTIER_DAILY_BASE = 3,		-- monthly.. TAEDIUM was 5
	SIBERIAN_FRONTIER_DAILY_RANGE = 6,		-- TAEDIUM was 11
	...
	PS_NAVAL_BARRAGE = 50,
	PS_ADD_TRIBAL_LAND = 200,
	PS_ADD_TRIBAL_LAND_EXTRA_COST_PER_PROVINCE = 5,
	PS_FORCE_MARCH = 2,
	...
	MIGRATORY_TRIBE_DEVELOPMENT_PROGRESS = 0.01, 	-- How much progress on development for each monthly tick
	...
	COHESION_NEIGHBOURING_COLONIZER = 0.25, --taedium, was 0.5
...
NFrontend = {
	...
	FRONTEND_POS_X = 3233.0,
	FRONTEND_POS_Y = 1100.0,
	FRONTEND_POS_Z = 1125.0,
	FRONTEND_LOOK_X = 3133.0,
	FRONTEND_LOOK_Y = 0.0,
	FRONTEND_LOOK_Z = 1575.0,
...
NReligion = {
	...
	CONSECRATE_PATRIACH_AUTHORITY_BOOST = 0.1, --5% or so
	CONSECRATE_PATRIARCH_THRESHOLD = 30, --in development
	ORTHODOX_ICON_DURATION_MONTHS = 600,
	ORTHODOX_ICON_AUTHORITY_COST = 0.15,
	...
	MIN_CARDINALS = 1,											-- Least amount of cardinals/ Starting cardinals
	MAX_CARDINALS = 49,											-- Max amount of cardinals
	MAX_CARDINALS_PER_COUNTRY = 1,								-- Max cardinals in a single country --TAEDIUM

	YEARLY_PAPAL_INFLUENCE_CATHOLIC = 0.5,						-- The amount of yearly papal influence you receive each year for being catholic
	YEARLY_PAPAL_INFLUENCE_PER_CARDINAL = 2,					-- The amount of yearly papal influence you receive each year for each cardinal you have active
